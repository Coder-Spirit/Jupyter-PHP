...
class zPHP
{
    ...
    public function htmlWorks($htmlData)
    {
        $this->send(
            'display_data',
            [
    ...
    public function vegaDummy($mime)
    {
        $this->send(
            'display_data',
            [
                'data'=>[
                    $mime=>file_get_contents('a1.vega')
                ],
                'metadata'=>[]
            ]
        );
